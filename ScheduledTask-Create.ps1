Write-Output "Creating scheduled task for Noraneko WinUpdater..."
$Title = "Noraneko WinUpdater"
...
$Action   = New-ScheduledTaskAction -Execute "Noraneko-WinUpdater.exe" -Argument "-scheduled" -WorkingDirectory "$PSScriptRoot"
